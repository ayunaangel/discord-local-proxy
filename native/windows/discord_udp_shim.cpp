...
FORWARD_DWORD_A(VerFindFileA,
                (DWORD flags, LPCSTR file, LPCSTR windows, LPCSTR app,
                 LPSTR current, PUINT current_length, LPSTR destination,
                 PUINT destination_length),
                (flags, file, windows, app, current, current_length, destination,
                 destination_length))
FORWARD_DWORD_W(VerFindFileW,
                (DWORD flags, LPCWSTR file, LPCWSTR windows, LPCWSTR app,
...
FORWARD_DWORD_A(VerInstallFileA,
                (DWORD flags, LPCSTR source_file, LPCSTR destination_file,
                 LPCSTR source_directory, LPCSTR destination_directory,
                 LPCSTR current_directory, LPSTR temporary_file,
...
FORWARD_DWORD_W(VerInstallFileW,
                (DWORD flags, LPCWSTR source_file, LPCWSTR destination_file,
                 LPCWSTR source_directory, LPCWSTR destination_directory,
                 LPCWSTR current_directory, LPWSTR temporary_file,
                 PUINT temporary_length),
                (flags, source_file, destination_file, source_directory,
                 destination_directory, current_directory, temporary_file,
                 temporary_length))
